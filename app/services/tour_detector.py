...
def detect_tour_key(user_message: str) -> str | None:
    ...
    if ("ferretti 55" in text or "ferreti 55" in text or "my way" in text) and is_morning(text):
        return "ferretti_55_morning"
    if ("ferretti 55" in text or "ferreti 55" in text or "my way" in text) and is_sunset(text):
