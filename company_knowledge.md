...
- Balanced between comfort and value
- More relaxed than Red

### Platinum Cruise
- Smaller group (up to ~14 guests)
- More premium and quieter experience

### Diamond Cruise
- Premium small group (up to ~20 guests)
- Highest level shared cruise
- More space, comfort, and upgraded service
...
- Customizable route and experience
- Ideal for couples, families, or groups

Important:
- Private cruises have fixed maximum guest capacity depending on vessel
- If group exceeds capacity → alternative vessel or custom arrangement required
...
- Not bookable online
- Always direct to WhatsApp for full-day requests
...
- Within 24h → 100% charge

Private cruises:
- Free cancellation up to 72h before
- Within 72h → 100% charge

---

### Weather Policy

- Cruises operate unless restricted by Port Authority
...
- Guests must be able to step onboard with assistance

### Pregnancy
- Generally allowed depending on stage
- Recommend contacting team if unsure
